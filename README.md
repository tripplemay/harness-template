...
| 📙 [03 · 开箱即用手册（greenfield）](docs/03-quickstart.md) | 新项目"我要现在就跑起来" | 前置条件 / 3 步初始化 / 第一个批次实战 / FAQ |
| 📔 [04 · 接入现有项目](docs/04-adopt-existing-project.md) | 已研发一半的项目想接入 Triad | 非破坏性接入 / 8 步落地 / 试点批次选型 / 风险对策 |
